s2tab <- fluidRow(column(width = 12,
                       ...
                       wellPanel(
                         ...
                         tabsetPanel(id = "body5Multi",
                                     tabPanel("By Global Group",
                                              ...
                                              pickerInput("fourTheoMultiGlobalGroupValues", "Sample Using Values:", choices = c(1,2), multiple = T, options = list(`actions-box` = TRUE, noneSelectedText = "Please select at least 1 option")),
                ...
                column(width = 9,
                       ...
                       bsCollapse(id = "theoMultiOptionsBox",
                                  bsCollapsePanel("Setup",
                                                  # fluidRow(
                                                  #   column(width = 12,
                                                  #          p("Visualise multiple patient activity. Filter on provided categories.",
                                                  #            actionLink(inputId = "fourTheoMultiInfo1",
