                                           ...
                                           box(width = 12, #title = "Clinical Characteristics",
                                               ...
                                               column(width = 12,
                                                      fluidRow(
                                                        ...
                                                        selectizeInput("oneClinMulti", "LTC(s) to Plot", choices = c(1,2), multiple = TRUE,
                                                                       options = list(
                                         ...
                                         fluidRow(
                                           box(width = 12,
                                               fluidRow(column(width = 6,
                                                               selectInput("twoClusterVar2", "Plot", choices = c(1,2)),
                                           ...
                                           box(width = 12, title = "Data Tables",
                                               fluidRow(column(width = 5,
                                                               pickerInput("oneGeneralTableX", "By", choices = c(1,2), options = list(size = 12))
                                               ),
                                               column(width = 5,
                                ...
                                fluidRow(
                                  box(width = 12,
                                      ...
                                      tabsetPanel(id = "TheoType",
                                                  tabPanel("Individual Theoplots", s1tab ),
                                                  tabPanel("Group Theoplots", s2tab ),
                                                  type = "tabs"
                                      )
                                  )
                                )
