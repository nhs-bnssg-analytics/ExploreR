                                  ...
                                  column(width = 9,
                                         fluidRow(
                                           ...
                                           box(width = 12, title = "Edit GlobalGroups",
                                               fluidRow(
                                                 column(width = 6,
                                                          pickerInput("navTabCurrentGlobalVar", "Select Field to Remove", choices = c(1,2), options = list(size = 12)),
                                                 ),
                                               ...
                                               fluidRow(
                                                 column(width = 6,
                                                        pickerInput("navTabGlobalVar", "Select Field to Add", choices = c(1,2), options = list(size = 12)),
                                                 ),
                                                 column(width = 3,style = "margin-top: 25px;",align="center",
                                           ...
                                           box(width = 12, #title = "Clinical Characteristics",
                                               ...
                                               column(width = 12,
                                                      fluidRow(
                                                        ...
                                                        selectizeInput("oneClinMulti", "Clinical Conditions to Plot", choices = c(1,2), multiple = TRUE,
                                                                       options = list(
                                         ...
                                         fluidRow(
                                           box(width = 12, #title = "Activity Overview",
                                               fluidRow(
                                                 ...
                                                 column(width = 6,
                                                        selectInput("oneActCoA", "Metric to Graph", choices = c("Spend (Total, GBP)", "Spend per Capita (GBP)", "Activity", "Activity per Capita")),
                                                 )
                                               ),
                                  ...
                                  column(width = 10,
                                         fluidRow(
                                           box(width = 12, # title = "Wider Determinants",
                                               ...
                                               selectInput("oneWidDetX", "Determinant (X-Axis):", choices = c(1,2)),
                                               fluidRow(
                                                 column(width = 6,
                                ...
                                fluidRow(
                                         ...
                                         fluidRow(
                                           box(width = 12,
                                               fluidRow(column(width = 6,
                                                               selectInput("twoClusterVar2", "Y Axis (Segments)", choices = c(1,2)), # , options = list(size = 12)
                                                        ...
                                                        column(width = 6,
                                                               ...
                                                               selectizeInput(inputId = "twoClusterVar1",
                                                                              label = "Split Segments By",
                                                                              choices = c(1,2),
                                                                              options = list(
                                           ...
                                           box(width = 12, title = "Data Tables",
                                               fluidRow(column(width = 5,
                                                               pickerInput("oneGeneralTableX", "Split Data By", choices = c(1,2), options = list(size = 12)),
                                                               # selectInput(inputId = "twoClustersegment_layout",
                                                               #             label = "Compare segments together or individually",
                                                               #             choices = list(Stacked = "stacked",
                                                               #                            Separate = "separate")),
                                               ...
                                               column(width = 5,
                                                      pickerInput("oneGeneralTableFields", "Average Fields", choices = c(1,2), options = list(size = 12), multiple = TRUE),
                                                      # selectInput(inputId = "twoClustersegment_percent",
                                                      #             label = "Percent or count of population",
                                                      #             choices = list(Percent="percent",Count="freq")),
                                               ),
                                               column(width = 2, style = "margin-top: 25px;",
                                                      actionButton("oneGeneralGetTable", "Go!")
                                               ),
                                               column(width = 12,
                                                      uiOutput("oneGeneralGUI"),
                                                      br()
                                               )
                                               )
                                           )
                                  ...
                                  column(width = 2,
                                         fluidRow(
                                           div(
                                             box(width = 12,
                                                 p("On this page, multiple fields may be used to segment the population. Select up to two fields to generate barcharts (first box on page). These must have fewer than 20 unique elements each (restriction due to plotting time difficulties).",
                                                   "Second box generates a table (that may include many fields). The first attributes is used as the header; contents of 2nd dropdown are used as ",
                                                   "rows. Please note categorical character attributes may only be used as a header (as it is not possible to take average of characters). Clinical variables will be shaded based on % of population affected."),
                                                 p("")
                                             ), style = "position:fixed;  width:inherit;")
                                         )
                                  )
                                               ...
                                               fluidRow(
                                                        ...
                                                        column(width = 5,
                                                               pickerInput(
                                                                 ...
                                                                 label = "Predict",
                                                                 choices = c("Likelihood of activity [0,1]", "Expected activity (count)","Expected cost (GBP)"),# 
                                                                 selected = 1
                                                               ),
                                                        ),
                                                        column(width = 12,
                                                               br(),
                                                               bsCollapse(id = "riskOptions",
                                                                          bsCollapsePanel("Advanced Options",
                                                                                          fluidRow(
                                                                                            column(width = 12,
                                                                                                   ...
                                                                                                   fluidRow(
                                                                                                     column(width = 6,
                                                                                                            numericInput("fiveRiskMinProb", "Logistic Model Threshold", value = 0.5, min = 0, max = 1, step = 0.0001)
                                                                                                     ),
                                                                                                     column(width = 6, style = "margin-top: 15px;",
                                                                                                            p(" ", actionLink(inputId = "fiveRisk1Text1",
                                                                                                                              icon = icon("info-circle"),
                                                                                                                              label = HTML(""))),
                                                                                                            bsTooltip("fiveRisk1Text1", title = "Individuals in the population will be predicted to have activity if logistic regression output >= selected threshold.")
                                                                                                     ),
                                                                                                   ),
                                                                                                   fluidRow(
                                                                                                     column(width = 6,
                                                                                                            numericInput("fiveRiskTestProp", "Proportion as Training Data", value = 0.7, min = 0.1, max = 0.99, step = 0.01)
                                                                                                     ),
                                                                                                     column(width = 6, style = "margin-top: 15px;",
                                                                                                            p(" ", actionLink(inputId = "fiveRisk1Text4",
                                                                                                                              icon = icon("info-circle"),
                                                                                                                              label = HTML(""))),
                                                                                                            bsTooltip("fiveRisk1Text4", title = "Proportion of Analysis Dataset to use as training data for both regressions.")
                                                                                                     ),
                                                                                                   ),
                                                                                                   fluidRow(
                                                                                                     column(width = 6, 
                                                                                                            radioButtons("fiveRiskExcImpute", label = "Missing Data Handling",
                                                                                                                         choices = c("Exclude", "Impute"), selected = "Impute")
                                                                                                     ),
                                                                                                     column(width = 6, 
                                                                                                            actionButton("fiveRiskMissingDetails", label = "Missing Data Summary")
                                                                                                     )
                                                                                                   ),
                                                                                                   fluidRow(
                                                                                                     column(width = 6,
                                                                                                            checkboxInput("fiveRiskLogRAIC", "Use AIC for logistic regression optimisation"),
                                                                                                            checkboxInput("fiveRiskLinRAIC", "Use AIC for linear regression optimisation")
                                                                                                     ),
                                                                                                     column(width = 6,style = "margin-top: 15px;",
                                                                                                            p(" ", actionLink(inputId = "fiveRisk1Text2",
                                                                                                                              icon = icon("info-circle"),
                                                                                                                              label = HTML(""))),
                                                                                                            bsTooltip("fiveRisk1Text2", title = "AIC attemps to reduce model complexity by removing attributes which contribute little to the predictive ability of the model."),
                                                                                                            p(" ", actionLink(inputId = "fiveRisk1Text3",
                                                                                                                              icon = icon("info-circle"),
                                                                                                                              label = HTML(""))),
                                                                                                            bsTooltip("fiveRisk1Text3", title = "AIC attemps to reduce model complexity by removing attributes which contribute little to the predictive ability of the model.")
                                                                                                     ),
                                                                                                   )
                                                                                            )
                                                                                          )
                                         ...
                                         fluidRow(
                                           div(
                                             box(width = 12, id = "Risk1Info",style = "overflow-y: scroll;",
                                                 ...
                                                 p(" ", actionLink(inputId = "fiveRiskSetupInfo",
                                                                   label = HTML("About Setup Options"),
                                                                   icon = icon("info-circle"),
                                                                   style='font-size:100%')),
                                                 p(" ", actionLink(inputId = "fiveRiskLogInfo",
                                                                   label = HTML("About Logistic Regression Outputs"),
                                                                   icon = icon("info-circle"),
                                                                   style='font-size:100%')),
                                                 p(" ", actionLink(inputId = "fiveRiskLinInfo",
                                                                   label = HTML("About Linear Regression Outputs"),
                                                                   icon = icon("info-circle"),
                                                                   style='font-size:100%')),
                                                 p(" ", actionLink(inputId = "fiveRiskGroupsInfo",
                                                                   label = HTML("About Risk Group Outputs"),
                                                                   icon = icon("info-circle"),
                                                                   style='font-size:100%')),
